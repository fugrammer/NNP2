...
def sgd_momentum(cost, params, lr=0.5, decay=1e-6, momentum=0.5):
...
updates = sgd_momentum(cost, params, lr=0.5)
...
pylab.savefig('figure_2a2_layer1filter.png')
...
for i in range(20):
    ...
    pylab.savefig('figure_2a2_layer2filter'+str(i)+'.png')
...
pylab.savefig('figure_2a2_input.png')
...
pylab.savefig('figure_2a2_layer1convolvedfm.png')
...
pylab.savefig('figure_2a2_layer1pooledfm.png')
...
#pylab.title('convolved feature maps')
pylab.savefig('figure_2a2_layer2convolvedfm.png')
...
#pylab.title('pooled feature maps')
pylab.savefig('figure_2a2_layer2pooledfm.png')
